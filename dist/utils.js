...
module.exports = {
     ...
     * @returns {boolean}
     */
    verifySelector: function verifySelector(selector) {
        var validSelectors = ['all', 'label:', 'id:', 'group_id:', 'group:', 'location_id:', 'location:', 'scene_id:'],
            isValid = false;
